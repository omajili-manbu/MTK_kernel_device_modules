...
static void mtk_disp_cm_remove(struct platform_device *pdev) /* rodin stage2: 6.18 .remove is void */{
...
static const struct mtk_disp_cm_data mt6886_cm_driver_data = {
	.support_shadow = false,
	.need_bypass_shadow = true,
};
