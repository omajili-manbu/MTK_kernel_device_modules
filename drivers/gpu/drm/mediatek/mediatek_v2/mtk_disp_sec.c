...
static void disp_sec_remove(struct platform_device *pdev) /* rodin stage2: 6.18 .remove is void */{
...
static void disp_mtee_remove(struct platform_device *pdev) /* rodin stage2: 6.18 .remove is void */{
