...
static struct driver_attribute *mc3xxx_attr_list[] = {
	...
	&driver_attr_virtualz,    &driver_attr_orientation,
	&driver_attr_accuracy,    &driver_attr_selfcheck,
	&driver_attr_validate,    &driver_attr_pdoc,
};
...
{
#if IS_ENABLED(CONFIG_CUSTOM_KERNEL_ACCELEROMETER_MODULE)
	success_Flag = false;
#endif
}
