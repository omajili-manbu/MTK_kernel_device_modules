...
static void swpm_v6899_dbg_fs_init(void)
{
...
static int __init swpm_v6899_dbg_early_initcall(void)
{
	return 0;
}
...
static int __init swpm_v6899_dbg_late_initcall(void)
{
	/*
...
int __init swpm_v6899_dbg_init(void)
{
	...
	ret = swpm_v6899_dbg_early_initcall();
#endif
	if (ret)
		goto swpm_v6899_dbg_init_fail;

	ret = swpm_v6899_dbg_device_initcall();

	if (ret)
		goto swpm_v6899_dbg_init_fail;

#ifdef MTK_SWPM_KERNEL_MODULE
	ret = swpm_v6899_dbg_late_initcall();
#endif
	...
	return 0;
swpm_v6899_dbg_init_fail:
	return -EAGAIN;
}

void __exit swpm_v6899_dbg_exit(void)
{
	swpm_v6899_exit();
	swpm_v6899_ext_exit();
}
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("v6899 software power model debug module");
