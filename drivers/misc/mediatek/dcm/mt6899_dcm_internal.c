...
#define DCM_NODE "mediatek,mt6899-dcm"
...
void dcm_dump_regs(void)
{
	...
	REG_DUMP(CHABERTON_CORE0_CONFIG_REG_STALL_DCM_CONF);
	REG_DUMP(CHABERTON_CORE1_CONFIG_REG_STALL_DCM_CONF);
	REG_DUMP(CHABERTON_CORE2_CONFIG_REG_STALL_DCM_CONF);
	REG_DUMP(CHABERTON_CORE3_CONFIG_REG_STALL_DCM_CONF);
	REG_DUMP(CHABERTON_CORE4_CONFIG_REG_STALL_DCM_CONF);
	REG_DUMP(CHABERTON_CORE5_CONFIG_REG_STALL_DCM_CONF);
	REG_DUMP(CHABERTON_CORE6_CONFIG_REG_STALL_DCM_CONF);
	REG_DUMP(CHABERTON_CORE7_CONFIG_REG_STALL_DCM_CONF);
...
static int __init mt6899_dcm_init(void)
{
	int ret = 0;
...
static void __exit mt6899_dcm_exit(void)
{
}
