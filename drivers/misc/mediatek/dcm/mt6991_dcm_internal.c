...
#define DCM_NODE "mediatek,mt6991-dcm"
...
static int dcm_infra_is_on(void)
{
	...
	ret &= dcm_bcrm_apinfra_io_ctrl_ao_infra_bus_dcm_is_on();
	ret &= dcm_bcrm_apinfra_io_noc_ao_infra_bus_dcm_is_on();
...
void dcm_dump_regs(void)
{
	...
	REG_DUMP(CLK_FMEM_SUB_VDNR_DCM_TOP_APINFRA_MEM_INTX_BUS_u_APINFRA_MEM_INTX_BUS_CTRL_5);
	REG_DUMP(CLK_IO_NOC_VDNR_DCM_TOP_APINFRA_IO_INTF_PAR_BUS_u_APINFRA_IO_INTF_PAR_BUS_CTRL_0);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_ACP_SLAVE_DCM_EN);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_ADB_FIFO_DCM_EN);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_CBIP_CABGEN_1TO2_CONFIG);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_CBIP_CABGEN_1TO2_INFRA_CONFIG);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_CBIP_CABGEN_1TO2_L3GIC_CONFIG);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_CBIP_CABGEN_2TO1_CONFIG);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_CBIP_CABGEN_2TO5_CONFIG);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_CBIP_CABGEN_3TO1_CONFIG);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_CBIP_CABGEN_4TO2_CONFIG);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_CBIP_P2P_CONFIG0);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_CI700_DCM_CTRL);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_EBG_CKE_WRAP_FIFO_CFG);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_GIC_SPI_SLOW_CK_CFG);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_L3GIC_ARCH_CG_CONFIG);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_L3_SHARE_DCM_CTRL);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_MP0_DCM_CFG0);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_MP_ADB_DCM_CFG0);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_MP_CENTRAL_FABRIC_SUB_CHANNEL_CG);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_QDCM_CONFIG0);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_QDCM_CONFIG1);
	REG_DUMP(MCUSYS_PAR_WRAP_NON_SEC_QDCM_CONFIG2);
...
static int __init mt6991_dcm_init(void)
{
	int ret = 0;
...
static void __exit mt6991_dcm_exit(void)
{
}
MODULE_SOFTDEP("pre:mtk_dcm.ko");
module_init(mt6991_dcm_init);
module_exit(mt6991_dcm_exit);
